...
public class AddressAddedEvent extends DomainEvent {
  ...
  public AddressAddedEvent(UUID patientId, UUID addressId, String nombre, String linea1, String linea2, String ciudad, String provincia, String pais, Double lat, Double lng) {
  ...
  public String getEventName() {
    return "paciente.direccion-creada";
  }
