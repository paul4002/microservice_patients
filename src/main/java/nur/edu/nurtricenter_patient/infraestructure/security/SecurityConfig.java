...
public class SecurityConfig {
  ...
  public SecurityConfig(KeycloakJwtValidator jwtValidator, KeycloakProperties keycloakProperties, ObjectMapper objectMapper) {
  ...
  SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
      ...
      .addFilterBefore(
        new KeycloakJwtAuthenticationFilter(jwtValidator, objectMapper),
        UsernamePasswordAuthenticationFilter.class
      )
      .addFilterAfter(
        new DenyUsersFilter(keycloakProperties, objectMapper),
        KeycloakJwtAuthenticationFilter.class
      )
      .authorizeHttpRequests(auth -> auth
        .requestMatchers("/api/login", "/api/refresh", "/actuator/**").permitAll()
  ...
  @Bean
  HttpFirewall allowAnyHttpFirewall() {
